<style>
        ...
        * {
        ...
        .filter-controls-revenue > * {
            flex-grow: 1;
            max-width: 250px; /* Giới hạn chiều rộng cho các bộ lọc */
        }
        
        .date-input, .branch-select {
            padding: 10px 12px;
            border: 1px solid var(--border-color);
            border-radius: 4px;
            font-size: 14px;
        ...
        .revenue-stats {
            display: grid;
            grid-template-columns: repeat(3, 1fr); /* 3 cột cho các thẻ KPI nhỏ */
            gap: 20px;
            margin-bottom: 30px;
        }
        ...
        .stat-card {
            padding: 20px;
            border-left: 5px solid var(--primary-color); /* Đường kẻ nhấn */
            display: flex;
